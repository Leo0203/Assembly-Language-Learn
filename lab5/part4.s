...
KEY_ISR:
	...
	li t0, 1
	beq t1, t0, KEY0Pressed
	li t0, 2
	beq t1, t0, KEY1Pressed
	li t0, 4
	beq t1, t0, KEY2Pressed
	KEY0Pressed:
	la t0, RUN
	lw t1, (t0)
	...
	lw t2, 12(t0)
	slli t2, t2, 16
	add t1, t1, t2			# find the current starting value
	srli t1, t1, 1			# shift to the right as reduce the number by two
							# therefore count faster
	beq zero, t1, finished1	# if reach lower limit (0) do not update and go to ret
	sw t1, 8(t0)
	srli t1, t1, 16
	sw t1, 12(t0)
	
	finished1:
	li t1, 0b0111			# restart the timer
	sw t1, 4(t0)
	lw t0, (sp)
	lw t1, 4(sp)
	lw t2, 8(sp)
	...
	slli t2, t2, 16
	add t1, t1, t2			# find the current starting value
	slli t1, t1, 1			# shift to the left as increase the number by two
							# therefore count slower
	li t2, 100000000
	beq t2, t1, finished2	# if reach high limit (100,000,000) 
							# do not update and go to ret
	sw t1, 8(t0)
	srli t1, t1, 16
	sw t1, 12(t0)
